...
const OTP_SECRET = process.env.OTP_SECRET || 'babcf9a477168335bfeb07a37702a1e072297d2f2dbb0cf24df0bf9adcb393a6498a920942d76eb6'
...
const generateOTP = (cuid: string, issuedAt: number | null) => {
	...
	const code =
		hmac.readUInt32BE(hmac.length - 4) % 1_000_000
